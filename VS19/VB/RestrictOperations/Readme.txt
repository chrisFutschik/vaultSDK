...
Deploy the built files from the Configurator project to %programData%\Autodesk\Vault 2023\Extensions\RestrictOperations
...
Run Configuratior.exe from within the deployed directory.  Check the boxes of the operations you want to restrict.  Launch any Vault client application on that computer and run the restricted command.  You should see the operation blocked in the client.
